...
async function getEmails() {
    const response = await fetch('http://ec2-54-173-229-172.compute-1.amazonaws.com:8080/api/members/emails', {
...
async function login(email, password) {
    ...
    const response = await fetch('http://ec2-54-173-229-172.compute-1.amazonaws.com:8080/login', {
