...
async function updateStatus(id) {
    debugger
    console.log(id)
    const userid = document.querySelector(`.setActive-${id}`).dataset.id
    const status = document.querySelector(`.setActive-${id}`).dataset.status
    updateMemberStatus(userid, parseInt(status)).then((data) => {
        console.log(data)
        debugger
